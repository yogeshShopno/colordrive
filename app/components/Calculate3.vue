                      ...
                      <div class="basis-1/2">
                        <div class="calccardspacemini00 sticky top-32">
                          <div class="imgcalcdiv align-center rounded-md">
                            <img src="assets/images/calculator/cal3.png" alt="Interior Painting" width=""
                              ...
                              <div class="cal3fordiv0 capitalize">
                                <div class="mt-3">
                                  ...
                                  <div class="sm:col-span-3 mb-3">
                                    ...
                                    <div class="mt-2">
                                      <input type="mail" name="first-name" id="first-name" autocomplete="given-name"
                                        placeholder="Email"
                                        class="block shadow w-full rounded-md px-3 py-1 text-base custsselect h-11 text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                                    </div>
                                  </div>
                                  ...
                                  <div class="sm:col-span-3 mb-3">
                                    ...
                                    <div class="mt-2">
                                      <input type="number" name="first-name" id="first-name" autocomplete="given-name"
                                        placeholder="Mobile"
                                        class="block shadow w-full rounded-md px-3 py-1 text-base custsselect h-11 text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                                      <p class="text-gray-400 text-xs mt-1 text-end w-100">
                                        Verify with OTP
                                      </p>
                                    </div>
                                  </div>
                                  ...
                                  <div class="sm:col-span-3 mb-3">
                                    <label for="street-address"
                                      class="block text-sm/6 font-medium text-gray-900">Address 01</label>
                                    <div class="mt-2">
                                      <input type="text" name="street-address" id="street-address"
                                        placeholder="Address 01" autocomplete="street-address"
                                        class="block shadow w-full rounded-md px-3 py-1 text-base custsselect h-11 text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                                    </div>
                                  </div>
                                  ...
                                  <div class="sm:col-span-3 mb-3">
                                    <label for="street-address"
                                      class="block text-sm/6 font-medium text-gray-900">Address 02</label>
                                    <div class="mt-2">
                                      <input type="text" name="street-address" id="street-address"
                                        placeholder="Address 02" autocomplete="street-address"
                                        class="block shadow w-full rounded-md px-3 py-1 text-base custsselect h-11 text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                                    </div>
                                  </div>
                                  ...
                                  <div class="grid grid-cols-2 gap-3">
                                    <div class="mb-3">
                                      ...
                                      <div class="mt-2">
                                        <input type="number" name="pincode" id="pincode" placeholder="Address 02"
                                    ...
                                    <div class="mb-3">
                                      ...
                                      <div class="mt-2">
                                        <input type="text" name="state" id="state" placeholder="Gujarat"
                                          autocomplete="state"
                                          class="block shadow w-full rounded-md px-3 py-1 text-base custsselect h-11 text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                                      </div>
                                    </div>
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <div class="mt-2">
                                      <input type="date" name="date" id="date" placeholder="Gujarat" autocomplete="date"
                                        class="block shadow w-full rounded-md px-3 py-1 text-base custsselect h-11 text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                                    </div>
                                  </div>
                                  <div class="mb-3">
                                    <div class="flex gap-3">
                                      ...
                                      <div class="text-sm/6">
                                        <p id="offers-description" class="text-gray-500 text-sm">
