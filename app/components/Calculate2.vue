  ...
  export default {
    ...
    data() {
      return {
        products: [
          {
            name: "Tractor Suprem Emulsion",
            price: "₹ 9.5 / SqFt",
            image: "assets/images/calculator/paintbucket.png",
            tooltip: "Finishing : Matte<br>Washability : Non-Washable<br>Durability : 3-4 Years<br>VoC Content: Low<br>USP : Economical - Easy to paint<br>Unit Rate : ₹ 10/SqFt<br>Standard Total Cost : ₹ 24330/-",
          },
          {
            name: "Tractor Suprem Emulsion",
            price: "₹ 15 / SqFt",
    ...
    mounted() {
      this.$nextTick(() => {
        if (this.$refs.tooltipTargets) {
          this.$refs.tooltipTargets.forEach((el) => {
            tippy(el, {
...
<style>
  /* Add your custom tooltip styles here */
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                      <div class="row-span-66">
                        <div class="calccardspacemini0">
                          <div class="imgcalcdiv align-center bg-white custshadow flex justify-center p-4 rounded-md">
                            <img src="assets/images/calculator/asian.png" alt="Interior Painting" width=""
                      ...
                      <div class="row-span-6">
                        <div class="calccardspacemini0">
                          <div class="imgcalcdiv align-center bg-white custshadow flex justify-center p-4 rounded-md">
                            <img src="assets/images/calculator/citypaint.png" alt="Interior Painting" width=""
                              class="br-16 max-w-full h-16 object-contain" />
                          </div>
                        </div>
                      </div>
                      <div class="row-span-6">
                        <div class="calccardspacemini0">
                          <div class="imgcalcdiv align-center bg-white custshadow flex justify-center p-4 rounded-md">
                            <img src="assets/images/calculator/dulux.png" alt="Interior Painting" width=""
                              class="br-16 max-w-full h-16 object-contain" />
                          </div>
                        </div>
                      </div>
                      <div class="row-span-66">
                        <div class="calccardspacemini0">
                          <div class="imgcalcdiv align-center bg-white custshadow flex justify-center p-4 rounded-md">
                            <img src="assets/images/calculator/saifpaint.png" alt="Interior Painting" width=""
                              class="br-16 max-w-full h-16 object-contain" />
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 xs:grid-cols-2 gap-4">
                      <div class="row-span-66 h-full">
                        <div class="calccardspacemini0 h-full">
                          <div class="imgcalcdiv bg-light-pink h-full p-3 rounded-lg overflow-hiddenrounded-md">
                      ...
                      <div class="row-span-66 h-full">
                        <div class="calccardspacemini0 h-full">
                          <div class="imgcalcdiv bg-pink p-3 rounded h-full-lg overflow-hiddenrounded-md">
                ...
                <div class="calcspace">
                  ...
                  <div class="calccardspacemini">
                    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-5">
                      <div v-for="(product, index) in products" :key="index" ref="tooltipTargets" class="row-span-6"
                        :data-tippy-content="product.tooltip">

                        <div class="product-card relative bg-white custshadow p-4 rounded-lg">

                          <i class="fa-solid fa-circle-info absolute right-2 flex sm:block md:hidden hover:cursor-pointer"
                            style="color: #fc2f93ba;" @click="showTooltip(index)"></i>
                  ...
                  <div class="toggledivtonew">
                    <div class="toggledivcalspace mt-3">
                      ...
                      <label class="relative inline-flex items-center mt-4 cursor-pointer">
                        ...
                        <span class="ml-3 text-gray-500 dark:text-gray-500">Do you want to paint your ceiling?
                        </span>
                      </label>
                    </div>
                  </div>
                ...
                <div class="calcspace">
                  <form action="" method="post">
                    <div class="sm:col-span-3">
                      <label for="country" class="block text-sm/6 font-medium text-gray-900">Email for Free
                        Quotation</label>
                      <div class="mt-2">
                ...
                <div class="calcspace">
                  <div class="toggledivtonew">
                    <div class="toggledivcalspace mt-3">
                      <!-- Example Toggle -->
                      <label class="relative inline-flex items-center mt-4 cursor-pointer">
                        <input id="toggle-checkbox" type="checkbox" class="sr-only peer" @change="toggleSection" />
                        <div
                          class="w-11 h-6 bg-gray-300 rounded-full peer peer-checked:bg-pink-600 peer-focus:ring-pink-300 dark:peer-focus:ring-pink-800 dark:bg-gray-300 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all">
                        </div>
                        <span class="ml-3 text-gray-500 dark:text-gray-500">Select Product For Ceiling</span>
                      </label>
                    </div>
