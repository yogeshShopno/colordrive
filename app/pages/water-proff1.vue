            ...
            <div class="space-y-4">
              ...
              <div class="faqcustshadow rounded-lg px-4 pt-4">
                ...
                >
                  ...
                  >
                  <span
                    class="text-xl transition-transform duration-300 plus-minus-icon"
                    >+</span
                  >
                </button>
                <div
                  class="overflow-hidden transition-all duration-300 max-h-0 accordion-content"
                >
                  <div class="pt-3 pb-4">
