                                        ...
                                        <div class="flex sm:flex-row flex-col  gap-4">
                                            <div class="basis-[55vw]">
                                                <div class="calccardspacemini00 sticky top-32 grid grid-cols-2 gap-4">
                                                    ...
                                                    <div class="imgcalcdiv align-center rounded-md">
                                                        <img src="assets/images/calculator/colorshade2.png"
                                                            alt="Interior Painting" width=""
                                                            class="br-16 max-w-full object-contain w-full" />
                                                    </div>
                                                    <div class="imgcalcdiv align-center rounded-md">
                                                        <img src="assets/images/calculator/colorshade3.png"
                                                            alt="Interior Painting" width=""
                                                            class="br-16 max-w-full object-contain w-full" />
                                                    </div>
                                                    <div class="imgcalcdiv align-center rounded-md">
                                                        <img src="assets/images/calculator/colorshade4.png"
                                                            alt="Interior Painting" width=""
                                                            class="br-16 max-w-full object-contain w-full" />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row-span-6 h-full">
                                            <div
                                                ...
                                                <div class="imgcalcdiv custimgcal rounded">
                                                    <img src="assets/images/calculator/icn16.png"
                                                        alt="Interior Painting" width=""
...
<style scoped>
    @import "../assets/css/visualshadecontact.css";
</style>