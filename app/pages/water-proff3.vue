                                            ...
                                            <div class="basis-[45vw]">
                                                <div class="calccardspacemini0 faqcustshadow p-4 rounded-lg">
                                                    <div class="calccardtitle mb-3">
                                                        ...
                                                        <p class="text-gray-500 text-sm">Fill the form below to book a free site
                                                                ...
                                                                <div class="mt-3">
                                                                    ...
                                                                    <div class="sm:col-span-3 mb-3">
                                                                        ...
                                                                        <div class="mt-2">
                                                                            <input type="number" name="first-name"
                                                                                ...
                                                                                class="block shadow w-full rounded-md px-3 py-1 text-base custsselect h-11 text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                                                                            <p
                                                                                class="text-gray-400 text-xs mt-1 text-end w-100">Verify
                                                                                with OTP</p>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3"> 
                                                                        <div class="flex gap-3">
                                                                            ...
                                                                            <div class="text-sm/6"> 
                                                                              <p id="offers-description" class="text-gray-500 text-sm">T&C and Privacy Policy</p>
                                                                            </div>
                                                                          </div>
                                                                    </div>
                                                                    <div class="mt-6 flex items-center justify-end gap-x-6"> 
                                                                        <button type="submit" class="rounded-md btn-pink w-full px-3 py-2 text-sm font-semibold text-white shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Book Now</button>
                                                                      </div>
                                                                </div>
                                                            </div>
                                                        </form>
