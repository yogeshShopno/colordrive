    ...
    >
      ...
      <div class="text-center">
        <div class="flex items-center gap-2">
          ...
          <p class="text-gray-500 pink-txt">Painting Cost Calculator</p>
        </div>
      </div>
    </div>
    <section
                    ...
                    <div class="flex flex-col xl:flex-row gap-8">
                      <div class="basis-5/5 xl:basis-1/5">
                        ...
                        >
                          ...
                          <div class="calccardspacemini">
                            <div
                              class="grid grid-cols-4 xl:grid-cols-3 md:grid-cols-7 sm:grid-cols-6 gap-4"
                            >
                              <div class="row-span-661">
                                <div class="calccardspacemini0">
                                  ...
                                  >
                                    <img
                                      src="assets/images/calculator/dc1.png"
                                  ...
                                  <div class="lablediv mt-2 text-center">
                                    <p class="text-sm">General Cleaning</p>
                                  </div>
                                </div>
                              </div>
                              <div class="row-span-661">
                                <div class="calccardspacemini0">
                                  ...
                                  >
                                    <img
                                      src="assets/images/calculator/dc2.png"
                                      alt="Interior Painting"
                                      width=""
                                      class="w-full max-w-full h-auto"
                                    />
                                  ...
                                  <div class="lablediv mt-2 text-center">
                                    <p class="text-sm">Living Room Cleaning</p>
                                  </div>
                                </div>
                              </div>
                              <div class="row-span-661">
                                <div class="calccardspacemini0">
                                  ...
                                  >
                                    <img
                                      src="assets/images/calculator/dc3.png"
                                      alt="Interior Painting"
                                      width=""
                                      class="w-full max-w-full h-auto"
                                    />
                                  ...
                                  <div class="lablediv mt-2 text-center">
                                    <p class="text-sm">Bed Room Cleaning</p>
                                  </div>
                                </div>
                              </div>
                              <div class="row-span-661">
                                <div class="calccardspacemini0">
                                  ...
                                  >
                                    <img
                                      src="assets/images/calculator/dc4.png"
                                      alt="Interior Painting"
                                      width=""
                                      class="w-full max-w-full h-auto"
                                    />
                                  ...
                                  <div class="lablediv mt-2 text-center">
                                    <p class="text-sm">Kitchen Cleaning</p>
                                  </div>
                                </div>
                              </div>
                              <div class="row-span-661">
                                <div class="calccardspacemini0">
                                  ...
                                  >
                                    <img
                                      src="assets/images/calculator/dc5.png"
                                      alt="Interior Painting"
                                      width=""
                                      class="w-full max-w-full h-auto"
                                    />
                                  ...
                                  <div class="lablediv mt-2 text-center">
                                    <p class="text-sm">Sofa Cleaning</p>
                                  </div>
                                </div>
                              </div>
                              <div class="row-span-661">
                                <div class="calccardspacemini0">
                                  ...
                                  >
                                    <img
                                      src="assets/images/calculator/dc6.png"
                                      alt="Interior Painting"
                                      width=""
                                      class="w-full max-w-full h-auto"
                                    />
                                  ...
                                  <div class="lablediv mt-2 text-center">
                                    <p class="text-sm">Carpet Cleaning</p>
                                  </div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="basis-5/5 xl:basis-4/5">
                        <div
                          class="calccardspacemini0 faqcustshadow p-8 rounded-lg"
                        >
                          <div
                            class="flex gap-5 sm:flex-row flex-col items-center"
                          >
                            <div class="basis-1/2">
                              <h1 class="font-bold sm:text-5xl">
                                Premium Full House Cleaning
                              </h1>
                            </div>
                            <div
                            ...
                            >
                              <img
                                src="assets/images/calculator/dcmain.png"
                                alt="Interior Painting"
                                width=""
                                class="w-full max-w-full h-auto"
                              />
                        ...
                        <div class="flex gap-3 flex-col md:flex-row mt-8 gap-8">
                          <div class="basis-3/3 md:basis-2/3">
                            ...
                            >
                              <h5 class="text-2xl font-bold mb-5">Packages</h5>
                              <div class="packegescardmain">
                                <div class="flex gap-5 flex-col">
                                  <div class="packegescard p-5 rounded-2xl">
                                    <div
                                      class="flex flex-col gap-3 justify-between lg:flex-row md:flex-col sm:flex-col w-full"
                                    >
                                      <div class="packcardleft">
                                        ...
                                        >
                                          <p class="pink-txt font-bold">₹785</p>
                                          <p class="text-gray-500 line-through">
                                            ₹858
                                          </p>
                                          <p class="text-gray-500">· 2 hrs</p>
                                        </div>
                                        <div
                          ...
                          <div class="basis-3/3 md:basis-1/3">
                            <div class="sticky top-32">
                              <div
                                class="cartcardmain calccardspacemini00 faqcustshadow p-5 rounded-lg"
                              >
                                <div class="cartdiv">
                                  ...
                                  <div class="cartlistdiv flex flex-col gap-3">
                                    ...
                                    <div
                                      class="cartvietotldiv bg-pink-100 rounded-xl px-4 py-3"
                                    >
                                      <div
                                      ...
                                      >
                                        ...
                                        >
                                          <p class="pink-txt text-lg font-bold">
                                            ₹2000
                                          </p>
                                          <p class="text-gray-500 line-through">
                                            ₹2600
                                        ...
                                        <a
                                          href=""
                                          class="viewcaartbtn font-semibold"
                                          >View Cart</a
                                        >
                                      </div>
                                    </div>
                              ...
                              >
                                <div class="offerscardss">
                                  <div class="dicmain flex gap-2">
                                    <div
                                      class="discounticonimgdiv bg-gray-100 p-3 rounded-md"
                                    >
                                      <img
                                        src="assets/images/calculator/discounticon.png"
                                        alt="Interior Painting"
                                        width=""
                                        class="w-full max-w-full h-auto"
                                      />
                                  ...
                                  <div class="viewmoredisc mt-3">
                                    <a
                                      href=""
                                      class="viewmoredesc pink-txt font-semibold"
                                    >
                                      View More Offers
                                      <i
      ...
      <div class="detailsmodalcontentdiv">
        <div class="detailssliderimgdiv">
          <div class="calccardspacemini sliderdiv text1">
            <Swiper
              class="catalogue modalpopupproduct"
              :slides-per-view="1"
              :loop="true"
              :breakpoints="{
                0: { slidesPerView: 1 },
              ...
              <SwiperSlide class="h-100">
                <div class="text-center h-100">
                  <div class="calccardspacemini00">
                    <div
                      class="imgcalcdivv align-center flex justify-center overflow-hidden"
                    >
                      <img
                        src="assets/images/calculator/modalslider.png"
                        alt="Interior Painting"
                        width=""
          ...
          <div class="mt-8 producdetaildiv">
            <div class="packegescardd px-5 rounded-2xl">
              <div
                class="flex flex-col gap-3 justify-between lg:flex-row md:flex-col sm:flex-col w-full"
              >
                <div class="packcardleft">
                  ...
                  <div class="mb-3 reviewdivcard flex gap-3 items-center">
                    <i class="fa-solid fa-star"></i>
                    <p class="text-gray-500">4.383 (1.2M reviews)</p>
                  </div>
                  <div class="mb-3 pricedivmain flex gap-3">
                    <p class="pink-txt font-bold">₹785</p>
                    <p class="text-gray-500 line-through">₹858</p>
                    <p class="text-gray-500">· 2 hrs</p>
                  </div>
                  <div class="viewmoreivmain flex gap-3">
                    <p class="text-green-600 text-sm">₹73 off applied</p>
                  </div>
                </div>
                <div class="packcardright">
                  <div class="selectedinputdiv">
                    <div
                      class="flex items-center shadow rounded-md w-fit shadow-lg mx-auto inptdiv bg-white mt-min-15pxx border-pink"
                    >
                      <!-- Minus Button -->
                      <button
                        type="button"
                        class="px-3 py-2 text-base focus:outline-none"
                        onclick="decreaseQty()"
                      >
                        −
                      </button>
            ...
            <div class="packegescardd px-5 rounded-2xl">
              ...
              <div class="prodcardsliderpopup">
                ...
                >
                  <SwiperSlide class="h-100">
                    <div
                      class="servccarddiv .row-span-612 mx-3 mb-3 bg-white custshadow border-gray-700 overflow-hidden rounded-2xl"
                    >
                      ...
                      <div class="lablediv p-3">
                        ...
                        >
                          <div class="pricediv">
                            <p class="text-gray-500 font-semibold">₹599</p>
                          </div>
                          <div class="btnviewsdiv">
                            <a
                              href="/productpage"
                              id=" "
                              class="btn-pink btn-rounded rounded-lg text-white border px-8 px-4 py-2 focus:outline-none"
                            >
                              add
                            </a>
                          </div>
                  ...
                  <SwiperSlide class="h-100">
                    <div
                      class="servccarddiv .row-span-612 mx-3 bg-white custshadow border-gray-700 overflow-hidden rounded-2xl"
                    >
                      <div class="imgcalcdivv border-none">
                        <img
                          src="assets/images/calculator/prod1.png"
            ...
            <hr class="my-8" />
            <div class="packegescardd px-5 rounded-2xl">
              <h5 class="text-2xl font-semibold mb-4">Included</h5>
              <div class="prodcardsliderpopup">
                <div class="includedcrdsmain flex flex-col gap-4">
                  <div class="inclflex flex gap-3 items-center">
                    <div class="inclfleximg rounded-lg overflow-hidden">
                      <img
                        src="assets/images/calculator/include1.png"
                        alt=""
                        class="img-fluid"
                      />
                    </div>
                    <div class="inccontent">
                      <h5 class="font-bold text-base">Bathroom Cleaning</h5>
                      <p class="text-gray-500 text-sm">
                        Bathroom Cleaning Removal of hard water stains, yellow
                        spots, etc. 
                      </p>
                    </div>
                  </div>
            ...
            <hr class="my-8" />
            <div class="packegescardd px-5 rounded-2xl">
              <h5 class="text-2xl font-semibold mb-3">Excluded</h5>
              <p class="text-gray-500 text-sm">
                Cleaning of appliances, chandlier & terrace Removal of shelves
                objects (except kitchent) & reorganization Wet wiping of wall &
                ceiling
              </p>
            </div>
            <hr class="my-8" />
            <div class="packegescardd px-5 rounded-2xl">
              <div class="mb-5">
                <h5 class="text-2xl font-semibold mb-1">Spotless bathroom</h5>
                <p class="text-gray-500 text-sm">
                  thorough and systematic cleaning using suitable tools and
                  specially curated chemicals
                </p>
              </div>
              <div class="prodcardsliderpopup mt-5">
                <div class="spotlesbathudedcrdsmain flex gap-3">
                  <div
                    class="servccarddiv row-span-612 mb-3 bg-white custshadow border-gray-700 overflow-hidden rounded-2xl"
                  >
                    <div class="imgcalcdivv border-none">
                      <img
                        src="assets/images/calculator/spotlessbath.png"
                        alt="Interior Painting"
                        width=""
                        class="max-w-full w-full h-auto"
                      />
                    ...
                    <div class="lablediv p-3">
                      <h5 class="text-base font-bold">Trained Cleaners</h5>
                    </div>
                  </div>
                  <div
                    class="servccarddiv row-span-612 mb-3 bg-white custshadow border-gray-700 overflow-hidden rounded-2xl"
            ...
            <div class="packegescardd px-5 rounded-2xl">
              <div class="bannerimgdiv">
                <img
                  src="assets/images/calculator/shinechalange.png"
                  alt="Interior Painting"
                  width=""
                  class="max-w-full w-full h-auto"
                />
              ...
              <div class="mb-5">
                <h5 class="text-2xl font-semibold mb-1">
                  wghat is 1 hour shine challenge
                </h5>
                <p class="text-gray-500 text-sm">
                  our challenge that 1 hour we will deliver results better than
                  20 hours of regular cleaning
                </p>
              </div>
            </div>
            <hr class="my-8" />
            <div class="packegescardd px-5 rounded-2xl">
              <div class="bannerimgdiv">
                <img
                  src="assets/images/calculator/uccleaning.png"
                  alt="Interior Painting"
                  width=""
                  class="max-w-full w-full h-auto"
                />
                    ...
                    <div class="w-full shadow11 mb-4">
                      ...
                      <div class="accordion__content overflow-hidden">
                        <p class="accordion__body p-4 text-black" id="panel1">
                          ...
                          elit. Iusto possimus at a cum saepe molestias modi
                          illo facere ducimus voluptatibus praesentium deleniti
                          fugiat ab error quia sit perspiciatis velit
            ...
            <div class="packegescardd px-5 rounded-2xl">
              <div class="mb-5">
                <h5 class="text-2xl font-semibold mb-1">All reviews</h5>
              </div>
              <div class="allrevd flex flex-col gap-5">
                <div class="allrevcard">
                  <div class="cartvietotldiv bg-pink-100 rounded-xl px-4 py-3">
                    <div class="flex justify-between flex-col items-center">
                      <div
                        class="includedcrdsmain flex w-full justify-between mb-3 gap-4"
                      >
                        <div class="inclflex flex gap-3 items-center">
                          <div class="inclfleximg rounded-lg overflow-hidden">
                            <img
                              src="assets/images/calculator/avtar.png"
                              alt=""
                              class="img-fluid"
                            />
                          </div>
                          <div class="inccontent">
                            ...
                            <p class="text-gray-500 text-sm">
                              Dec 27, 2024 • For Classic bathroom cleaning 
                            </p>
                          </div>
                        </div>
                      ...
                      <p class="text-gray-500">
                        Cleaning was not proper and stains are still seen.
                        Service was done in 35 mins only for a bathroom and
                        seems adequate time was not spent for proper cleaning.
                      </p>
                    </div>
                  </div>
                </div>
