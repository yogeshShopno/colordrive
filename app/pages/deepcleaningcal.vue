                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="packcardleft">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <p class="pink-txt font-bold">₹785
                                                                                    </p>
                                                                                    <p
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <p
                                                                                        class="pink-txt text-lg font-bold">
                                                                                        ₹2000</p>
                                                                                    <p
                                                                                        class="text-gray-500 line-through">
                                                                                        ₹2600</p>
                                                                                ...
                                                                                <a href=""
                                                                                    class="viewcaartbtn font-semibold">View
                                                                                    Cart</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="offerscardss">
                                                                    <div class="dicmain flex  gap-2">
                                                                        ...
                                                                        <div class="textdiv">
                                                                            <p class="font-semibold">Assured reward from
                                                                                CRED</p>
                                                                            <p class="text-gray-500">Reward via online
                                                                                payment</p>
                                                                        </div>
                                                                    </div>
            ...
            <div class="detailsmodalcontentdiv">
                <div class="detailssliderimgdiv">
                    <div class="calccardspacemini sliderdiv text1">
                        <Swiper class="catalogue modalpopupproduct" :slides-per-view="1" :loop="true" :breakpoints="{
                            0: { slidesPerView: 1 }, 
                            575: { slidesPerView: 1 }, 
                            768: { slidesPerView: 1 },
                          ...
                          }" :pauseAutoplayOnMouseEnter="true" :pagination="{
                            clickable: true,
                          }">
                            <SwiperSlide class="h-100">
                                <div class="text-center h-100">
                                    <div class="calccardspacemini00">
                                        <div class="imgcalcdivv align-center flex justify-center overflow-hidden">
                                            <img src="assets/images/calculator/modalslider.png" alt="Interior Painting"
                                                width="" class="max-w-full h-auto" />
                                        </div>
                                    </div>
                                </div>
                            </SwiperSlide>
                    ...
                    <div class="mt-8 producdetaildiv">
                                ...
                                <div class="packcardright">
                                    <div class="selectedinputdiv">
                                        <div
                                            ...
                                            <!-- Minus Button -->
                                            <button type="button" class="px-3 py-2 text-base focus:outline-none"
                                                onclick="decreaseQty()">
                                                −
                                            </button>
                        ...
                        <div class="packegescardd px-5 rounded-2xl">
                            ...
                            <div class=" prodcardsliderpopup">
                                <Swiper class="catalogue modalpopupproduct" :slides-per-view="1" :loop="true"
                                    :breakpoints="{
                                    0: { slidesPerView: 1 }, 
                                    ...
                                    <SwiperSlide class="h-100">
                                        <div
                                            ...
                                            <div class="imgcalcdivv border-none">
                                                <img src="assets/images/calculator/prod1.png" alt="Interior Painting"
                                ...
                                <div class="includedcrdsmain flex flex-col gap-4">
                                    <div class="inclflex flex gap-3 items-center">
                                        <div class="inclfleximg rounded-lg overflow-hidden">
                                            <img src="assets/images/calculator/include1.png" alt="" class="img-fluid">
                                        </div>
                                        <div class="inccontent">
                                            <h5 class="font-bold text-base">Bathroom Cleaning</h5>
                                            <p class="text-gray-500 text-sm">Bathroom Cleaning Removal of hard water
                                                stains, yellow spots, etc. </p>
                                        </div>
                                    </div>
                                    <div class="inclflex flex gap-3 items-center">
                                        <div class="inclfleximg rounded-lg overflow-hidden">
                        ...
                        <div class="packegescardd px-5 rounded-2xl">
                            ...
                            <p class="text-gray-500 text-sm">Cleaning of appliances, chandlier & terrace Removal of
                                shelves objects (except kitchent) & reorganization Wet wiping of wall & ceiling</p>
                        </div>
                        <hr class="my-8">
                        <div class="packegescardd px-5 rounded-2xl">
                            <div class="mb-5">
                                ...
                                <p class="text-gray-500 text-sm"> thorough and systematic cleaning using suitable tools
                                    and specially curated chemicals</p>
                            </div>
                            <div class=" prodcardsliderpopup mt-5">
                                <div class="spotlesbathudedcrdsmain flex gap-3">
                                    <div
                                        ...
                                        <div class="imgcalcdivv border-none">
                                            <img src="assets/images/calculator/spotlessbath.png" alt="Interior Painting"
                                                width="" class="max-w-full w-full h-auto" />
                                        </div>
                                        <div class="lablediv p-3">
                                            <h5 class="text-base font-bold">
                        ...
                        <div class="packegescardd px-5 rounded-2xl">
                            <div class="bannerimgdiv">
                                <img src="assets/images/calculator/shinechalange.png" alt="Interior Painting" width=""
                            ...
                            <div class="mb-5">
                                ...
                                <p class="text-gray-500 text-sm">our challenge that 1 hour we will deliver results
                                    better than 20 hours of regular cleaning</p>
                            </div>
                        </div>
                        <hr class="my-8">
                        <div class="packegescardd px-5 rounded-2xl">
                            <div class="bannerimgdiv">
                                <img src="assets/images/calculator/uccleaning.png" alt="Interior Painting" width=""
                                    class="max-w-full w-full h-auto" />
                            </div>
                        </div>
                        <hr class="my-8">
