                                ...
                                <div class="calcspace">
                                    ...
                                    <div class="toggledivcalspace mt-3">
                                        ...
                                        <label class="relative inline-flex items-center mt-4 cursor-pointer">
                                            ...
                                            <span class="ml-3 text-gray-500 dark:text-gray-500">Do you want to paint
                                                your ceiling?</span>
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <form action="" method="post">
                                        <div class="sm:col-span-3">
                                            ...
                                            <div class="mt-2">
                                                <div class="flex flex-col gap-4 sm:flex-row">
                                                    ...
                                                    <a href=""
                                                        class="btn btn-rounded btn-pink text-center px-3 py-2">Email
                                                        Free Quotation</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="toggledivcalspace mt-3">
                                            ...
                                            <label class="relative inline-flex items-center mt-4 cursor-pointer">
                                                ...
                                                <span class="ml-3 text-gray-500 dark:text-gray-500">Select Product For
                                                    Ceiling</span>
                                            </label>
                                        </div>
                                    </form>
                        ...
                        <div class="relative">
                            ...
                            <div class="flex justify-between align-center">
                                ...
                                <div id="carousel"
                                    ...
                                    <a href="/calculator" class="w-3 h-3 bg-gray-300 rounded-full focus:outline-none"
                                        onclick="goToSlide(0)"></a>
                                    <a href="/calculator-2" class="w-3 h-3 bg-pink-500 rounded-full focus:outline-none"
